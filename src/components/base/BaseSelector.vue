<template>
    <div class="relative w-full" @click="handleDropdownClick">
        <div
            ...
            class="flex items-center border border-blue-400 rounded-lg px-3 py-2 cursor-pointer"
        >
            ...
            <div class="flex flex-col flex-grow">
                ...
                <span class="text-gray-700">{{ displayedCount }} guests</span>
            </div>
            <span class="ml-auto">
                <AppIcon
        ...
        >
            ...
            >
                ...
                <div class="flex items-center">
                    ...
                    <span class="mx-2 w-6 text-center">{{ option.count }}</span>
